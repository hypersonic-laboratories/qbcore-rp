...
QBCore.Shared.Items = {
    ...
    weapon_acm = { name = 'weapon_acm', label = 'ACM', weight = 1000, type = 'weapon', image = 'weapon_acm.png', asset_name = 'ID_Weapon_Rifle_ACM', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_austro = { name = 'weapon_austro', label = 'AUSTRO', weight = 1000, type = 'weapon', image = 'weapon_austro.png', asset_name = 'ID_Weapon_Rifle_Austro', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_banshee = { name = 'weapon_banshee', label = 'BANSHEE', weight = 1000, type = 'weapon', image = 'weapon_banshee.png', asset_name = 'ID_Weapon_Pistol_Banshee', ammo_type = 'pistol_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_bison = { name = 'weapon_bison', label = 'BISON', weight = 1000, type = 'weapon', image = 'weapon_bison.png', asset_name = 'ID_Weapon_SMG_Bison', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_cs446 = { name = 'weapon_cs446', label = 'CS-446', weight = 1000, type = 'weapon', image = 'weapon_cs446.png', asset_name = 'ID_Weapon_Sniper_CS-446', ammo_type = 'snp_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_condor = { name = 'weapon_condor', label = 'CONDOR', weight = 1000, type = 'weapon', image = 'weapon_condor.png', asset_name = 'ID_Weapon_Rifle_Condor', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_convert = { name = 'weapon_convert', label = 'CONVERT', weight = 1000, type = 'weapon', image = 'weapon_convert.png', asset_name = 'ID_Weapon_SMG_Convert', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_db12 = { name = 'weapon_db12', label = 'DB-12', weight = 1000, type = 'weapon', image = 'weapon_db12.png', asset_name = 'ID_Weapon_Shotgun_DB-12', ammo_type = 'shotgun_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_dmc68 = { name = 'weapon_dmc68', label = 'DMC-68', weight = 1000, type = 'weapon', image = 'weapon_dmc68.png', asset_name = 'ID_Weapon_Sniper_DMC-68', ammo_type = 'snp_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_fang = { name = 'weapon_fang', label = 'FANG', weight = 1000, type = 'weapon', image = 'weapon_fang.png', asset_name = 'ID_Weapon_SMG_Fang', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_fierro = { name = 'weapon_fierro', label = 'FIERRO', weight = 1000, type = 'weapon', image = 'weapon_fierro.png', asset_name = 'ID_Weapon_Pistol_Fierro', ammo_type = 'pistol_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_finisher = { name = 'weapon_finisher', label = 'FINISHER', weight = 1000, type = 'weapon', image = 'weapon_finisher.png', asset_name = 'ID_Weapon_Shotgun_Finisher', ammo_type = 'shotgun_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_freq = { name = 'weapon_freq', label = 'FREQ', weight = 1000, type = 'weapon', image = 'weapon_freq.png', asset_name = 'ID_Weapon_SMG_Freq', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_gaston = { name = 'weapon_gaston', label = 'GASTON', weight = 1000, type = 'weapon', image = 'weapon_gaston.png', asset_name = 'ID_Weapon_Pistol_Gaston', ammo_type = 'pistol_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_kal = { name = 'weapon_kal', label = 'KAL', weight = 1000, type = 'weapon', image = 'weapon_kal.png', asset_name = 'ID_Weapon_Rifle_KAL', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_kfs = { name = 'weapon_kfs', label = 'KFS', weight = 1000, type = 'weapon', image = 'weapon_kfs.png', asset_name = 'ID_Weapon_LMG_KFS', ammo_type = 'mg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_ktk = { name = 'weapon_ktk', label = 'KTK', weight = 1000, type = 'weapon', image = 'weapon_ktk.png', asset_name = 'ID_Weapon_Shotgun_KTK', ammo_type = 'shotgun_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_krink = { name = 'weapon_krink', label = 'KRINK', weight = 1000, type = 'weapon', image = 'weapon_krink.png', asset_name = 'ID_Weapon_Rifle_Krink', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_lws32 = { name = 'weapon_lws32', label = 'LWS-32', weight = 1000, type = 'weapon', image = 'weapon_lws32.png', asset_name = 'ID_Weapon_LMG_LWS-32', ammo_type = 'mg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_m77 = { name = 'weapon_m77', label = 'M77', weight = 1000, type = 'weapon', image = 'weapon_m77.png', asset_name = 'ID_Weapon_SMG_M77', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_mk4 = { name = 'weapon_mk4', label = 'MK4', weight = 1000, type = 'weapon', image = 'weapon_mk4.png', asset_name = 'ID_Weapon_Rifle_MK4', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_mirage = { name = 'weapon_mirage', label = 'MIRAGE', weight = 1000, type = 'weapon', image = 'weapon_mirage.png', asset_name = 'ID_Weapon_Pistol_Mirage', ammo_type = 'pistol_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_mouflan = { name = 'weapon_mouflan', label = 'MOUFLAN', weight = 1000, type = 'weapon', image = 'weapon_mouflan.png', asset_name = 'ID_Weapon_SMG_Mouflan', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_orion = { name = 'weapon_orion', label = 'ORION', weight = 1000, type = 'weapon', image = 'weapon_orion.png', asset_name = 'ID_Weapon_SMG_Orion', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_pm99 = { name = 'weapon_pm99', label = 'PM-99', weight = 1000, type = 'weapon', image = 'weapon_pm99.png', asset_name = 'ID_Weapon_SMG_PM-99', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_ppy = { name = 'weapon_ppy', label = 'PP-Y', weight = 1000, type = 'weapon', image = 'weapon_ppy.png', asset_name = 'ID_Weapon_SMG_PP-Y', ammo_type = 'smg_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_patriot = { name = 'weapon_patriot', label = 'PATRIOT', weight = 1000, type = 'weapon', image = 'weapon_patriot.png', asset_name = 'ID_Weapon_Rifle_Patriot', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_pitviper = { name = 'weapon_pitviper', label = 'PIT VIPER', weight = 1000, type = 'weapon', image = 'weapon_pitviper.png', asset_name = 'ID_Weapon_Rifle_Pit_Viper', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_queen80 = { name = 'weapon_queen80', label = 'QUEEN 80', weight = 1000, type = 'weapon', image = 'weapon_queen80.png', asset_name = 'ID_Weapon_Rifle_Queen-80', ammo_type = 'rifle_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_remi = { name = 'weapon_remi', label = 'REMI', weight = 1000, type = 'weapon', image = 'weapon_remi.png', asset_name = 'ID_Weapon_Shotgun_Remi', ammo_type = 'shotgun_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_roger = { name = 'weapon_roger', label = 'ROGER', weight = 1000, type = 'weapon', image = 'weapon_roger.png', asset_name = 'ID_Weapon_Pistol_Roger', ammo_type = 'pistol_ammo', unique = true, useable = true, shouldClose = true, description = '' },
    weapon_roma12 = { name = 'weapon_roma12', label = 'ROMA 12', weight = 1000, type = 'weapon', image = 'weapon_roma12.png', asset_name = 'ID_Weapon_Shotgun_Roma-12', ammo_type = 'shotgun_ammo', unique = true, useable = true, shouldClose = true, description = '' },
