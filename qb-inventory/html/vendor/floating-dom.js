!(function (t, e) {
    ...
    function L(t) {
        const e = T(t);
        return x(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : d(e) && p(e) ? e : L(e);
    }
    function R(t, e, n) {
        var o;
        ...
        const i = L(t),
            ...
            c = s(i);
        return r ? e.concat(c, c.visualViewport || [], p(i) ? i : [], c.frameElement && n ? R(c.frameElement) : []) : e.concat(i, R(i, [], n));
    }
    function E(t) {
        const e = v(t);
    ...
    function F(t) {
        const e = s(t);
        return w() && e.visualViewport ? { x: e.visualViewport.offsetLeft, y: e.visualViewport.offsetTop } : S;
    }
    function D(t, n, o, i) {
    ...
    function W(t) {
        return D(f(t)).left + b(t).scrollLeft;
    }
    function M(t, n, i) {
        let r;
        if ("viewport" === n)
            ...
            r = (function (t) {
                ...
                const s = -n.scrollTop;
                return ("rtl" === v(i).direction && (l += o(e.clientWidth, i.clientWidth) - r), { width: r, height: c, x: l, y: s });
            })(f(t));
        else if (a(n))
            r = (function (t, e) {
    ...
    function z(t, e) {
        const n = T(t);
        return !(n === e || !a(n) || x(n)) && ("fixed" === v(n).position || z(n, e));
    }
    function A(t, e, n, o) {
        const i = d(e),
            r = f(e),
        ...
        const h = c(0);
        if (i || (!i && !s))
            if ((("body" !== l(e) || p(r)) && (a = b(e)), i)) {
                const t = D(e, !0, s, e);
                ((h.x = t.x + e.clientLeft), (h.y = t.y + e.clientTop));
            } else r && (h.x = W(r));
        let m = u.left + a.scrollLeft - h.x,
            g = u.top + a.scrollTop - h.y;
        const [y, w, x] = H(o);
        return (y && ((m += w), (g += x), i && ((m += e.clientLeft), (g += e.clientTop))), { x: m, y: g, width: u.width, height: u.height });
    }
    function V(t, e) {
    ...
    function B(t, e) {
        ...
        if (!d(t)) return n;
        let o = V(t, e);
        for (; o && m(o) && "static" === v(o).position; ) o = V(o, e);
        return o && ("html" === l(o) || ("body" === l(o) && "static" === v(o).position && !g(o))) ? n : o || y(t) || n;
    }
    const N = {
        convertOffsetParentRelativeRectToViewportRelativeRect: function (t) {
            ...
            const h = c(0),
                m = d(o);
            if ((m || (!m && "fixed" !== i)) && (("body" !== l(o) || p(r)) && (u = b(o)), d(o))) {
                const t = D(o);
                ((a = O(o)), (h.x = t.x + o.clientLeft), (h.y = t.y + o.clientTop));
            }
            return { width: n.width * a.x, height: n.height * a.y, x: n.x * a.x - u.scrollLeft * a.x + h.x, y: n.y * a.y - u.scrollTop * a.y + h.y };
        },
                    ...
                    ...("clippingAncestors" === i
                        ? (function (t, e) {
                              ...
                              for (; a(c) && !x(c); ) {
                                  const e = v(c),
                                      n = g(c);
                                  (n || "fixed" !== e.position || (i = null), (r ? !n && !i : (!n && "static" === e.position && i && ["absolute", "fixed"].includes(i.position)) || (p(c) && !n && z(t, c))) ? (o = o.filter((t) => t !== c)) : (i = e), (c = T(c)));
                              }
                              return (e.set(t, o), o);
                          })(e, this._c)
                        : [].concat(i)),
        ...
        getElementRects: async function (t) {
            const e = this.getOffsetParent || B,
                n = this.getDimensions;
            return { reference: A(t.reference, await e(t.floating), t.strategy, t.floating), floating: { x: 0, y: 0, ...(await n(t.floating)) } };
        },
    ...
    (Object.defineProperty(t, "detectOverflow", {
        ...
        (t.autoUpdate = function (t, e, i, c) {
            void 0 === c && (c = {});
            const { ancestorScroll: l = !0, ancestorResize: s = !0, elementResize: u = "function" == typeof ResizeObserver, layoutShift: a = "function" == typeof IntersectionObserver, animationFrame: d = !1 } = c,
                h = C(t),
                p = l || s ? [...(h ? R(h) : []), ...R(e)] : [];
            p.forEach((t) => {
                    ...
                    ? (function (t, e) {
                          ...
                          return (
                              (function f(u, a) {
                                  ...
                                  if ((u || e(), !p || !m)) return;
                                  const g = { rootMargin: -r(h) + "px " + -r(l.clientWidth - (d + p)) + "px " + -r(l.clientHeight - (h + m)) + "px " + -r(d) + "px", threshold: o(0, n(1, a)) || 1 };
                                  let y = !0;
                                  function w(t) {
