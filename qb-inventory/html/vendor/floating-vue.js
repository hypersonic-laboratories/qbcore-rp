(function (l, s) {
    typeof exports == "object" && typeof module < "u" ? s(exports, require("vue"), require("@floating-ui/dom")) : typeof define == "function" && define.amd ? define(["exports", "vue", "@floating-ui/dom"], s) : ((l = typeof globalThis < "u" ? globalThis : l || self), s((l.FloatingVue = {}), l.Vue, l.FloatingUIDOM));
})(this, function (l, s, m) {
    "use strict";
    function ee(e, t) {
        for (const o in t) Object.prototype.hasOwnProperty.call(t, o) && (typeof t[o] == "object" && e[o] ? ee(e[o], t[o]) : (e[o] = t[o]));
    }
    const u = { disabled: !1, distance: 5, skidding: 0, container: "body", boundary: void 0, instantMove: !1, disposeTimeout: 150, popperTriggers: [], strategy: "absolute", preventOverflow: !0, flip: !0, shift: !0, overflowPadding: 0, arrowPadding: 0, arrowOverflow: !0, autoHideOnMousedown: !1, themes: { tooltip: { placement: "top", triggers: ["hover", "focus", "touch"], hideTriggers: (e) => [...e, "click"], delay: { show: 200, hide: 0 }, handleResize: !1, html: !1, loadingContent: "..." }, dropdown: { placement: "bottom", triggers: ["click"], delay: 0, handleResize: !0, autoHide: !0 }, menu: { $extend: "dropdown", triggers: ["hover", "focus"], popperTriggers: ["hover"], delay: { show: 0, hide: 400 } } } };
    function _(e, t) {
        let o = u.themes[e] || {},
            i;
        do ((i = o[t]), typeof i > "u" ? (o.$extend ? (o = u.themes[o.$extend] || {}) : ((o = null), (i = u[t]))) : (o = null));
        while (o);
        return i;
    }
    function Ce(e) {
        const t = [e];
        let o = u.themes[e] || {};
        do o.$extend && !o.$resetCss ? (t.push(o.$extend), (o = u.themes[o.$extend] || {})) : (o = null);
        while (o);
    ...
    function te(e) {
        const t = [e];
        let o = u.themes[e] || {};
        do o.$extend ? (t.push(o.$extend), (o = u.themes[o.$extend] || {})) : (o = null);
        while (o);
        return t;
    }
    const ht = "",
    ...
    let oe = !1;
    typeof window < "u" && typeof navigator < "u" && (oe = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream);
    const E = ["auto", "top", "bottom", "left", "right"].reduce((e, t) => e.concat([t, `${t}-start`, `${t}-end`]), []),
        M = { hover: "mouseenter", focus: "focus", click: "click", touch: "touchstart", pointer: "pointerdown" },
        O = { hover: "mouseleave", focus: "blur", click: "click", touch: "touchend", pointer: "pointerup" };
    function ie(e, t) {
        const o = e.indexOf(t);
        o !== -1 && e.splice(o, 1);
    }
            ...
            s.defineComponent({
                ...
                methods: {
                    ...
                    async $_computePosition() {
                        ...
                        (this.distance || this.skidding) && e.middleware.push(m.offset({ mainAxis: this.distance, crossAxis: this.skidding }));
                        const t = this.placement.startsWith("auto");
                        if (
                            (t ? e.middleware.push(m.autoPlacement({ alignment: this.placement.split("-")[1] ?? "" })) : (e.placement = this.placement),
                            this.preventOverflow && (this.shift && e.middleware.push(m.shift({ padding: this.overflowPadding, boundary: this.boundary, crossAxis: this.shiftCrossAxis })), !t && this.flip && e.middleware.push(m.flip({ padding: this.overflowPadding, boundary: this.boundary }))),
                            e.middleware.push(m.arrow({ element: this.$_arrowNode, padding: this.arrowPadding })),
                            this.arrowOverflow &&
                                e.middleware.push({
                                    name: "arrowOverflow",
                                    fn: ({ placement: i, rects: n, middlewareData: p }) => {
                                        ...
                                        return (i.startsWith("top") || i.startsWith("bottom") ? (a = Math.abs(d) > n.reference.width / 2) : (a = Math.abs(d) > n.reference.height / 2), { data: { overflow: a } });
                                    },
                                }),
                            ...
                            e.middleware.push({
                                ...
                                fn: ({ rects: n, placement: p, middlewareData: a }) => {
                                    ...
                                    let d, f;
                                    return (p.startsWith("top") || p.startsWith("bottom") ? (d = n.reference.width) : (f = n.reference.height), (this.$_innerNode.style[i === "min" ? "minWidth" : i === "max" ? "maxWidth" : "width"] = d != null ? `${d}px` : null), (this.$_innerNode.style[i === "min" ? "minHeight" : i === "max" ? "maxHeight" : "height"] = f != null ? `${f}px` : null), { data: { skip: !0 }, reset: { rects: !0 } });
                                },
                            });
                        }
                        ...
                        const o = await m.computePosition(this.$_referenceNode, this.$_popperNode, e);
                    ...
                    $_scheduleShow(e, t = !1) {
                        if ((this.$_updateParentShownChildren(!0), (this.$_hideInProgress = !1), clearTimeout(this.$_scheduleTimer), $ && this.instantMove && $.instantMove && $ !== this.parentPopper)) {
                    ...
                    $_scheduleHide(e, t = !1) {
                        ...
                        (this.$_updateParentShownChildren(!1), (this.$_hideInProgress = !0), clearTimeout(this.$_scheduleTimer), this.isShown && ($ = this), t ? this.$_applyHide() : (this.$_scheduleTimer = setTimeout(this.$_applyHide.bind(this), this.$_computeDelay("hide"))));
                    },
                    $_computeDelay(e) {
                        const t = this.delay;
                        ...
                        (clearTimeout(this.$_disposeTimer),
                            ...
                            !this.isShown &&
                                ...
                                this.positioningDisabled ||
                                    this.$_registerEventListeners([...m.getOverflowAncestors(this.$_referenceNode), ...m.getOverflowAncestors(this.$_popperNode)], "scroll", () => {
                    ...
                    async $_applyShowEffect() {
                        ...
                        if (e) {
                            let t;
                            for (let o = 0; o < h.length; o++) ((t = h[o]), t.showGroup !== e && (t.hide(), t.$emit("close-group")));
                        }
                        (h.push(this), document.body.classList.add("v-popper--some-open"));
                        for (const t of te(this.theme)) (ne(t).push(this), document.body.classList.add(`v-popper--some-open--${t}`));
                        (this.$emit("apply-show"), (this.classes.showFrom = !0), (this.classes.showTo = !1), (this.classes.hideFrom = !1), (this.classes.hideTo = !1), await H(), (this.classes.showFrom = !1), (this.classes.showTo = !0), this.noAutoFocus || this.$_popperNode.focus());
                    },
                    async $_applyHide(e = !1) {
                        ...
                        ((this.skipTransition = e), ie(h, this), h.length === 0 && document.body.classList.remove("v-popper--some-open"));
                        for (const o of te(this.theme)) {
                            const i = ne(o);
                            (ie(i, this), i.length === 0 && document.body.classList.remove(`v-popper--some-open--${o}`));
                        }
                        ($ === this && ($ = null), (this.isShown = !1), this.$_applyAttrsToTarget({ "aria-describedby": void 0, "data-popper-shown": void 0 }), clearTimeout(this.$_disposeTimer));
                    ...
                    $_addEventListeners() {
                        ...
                        (this.$_registerTriggerListeners(this.$_targetNodes, M, this.triggers, this.showTriggers, e), this.$_registerTriggerListeners([this.$_popperNode], M, this.popperTriggers, this.popperShowTriggers, e));
                        const t = (o) => {
                    ...
                    $_registerEventListeners(e, t, o) {
                        (this.$_events.push({ targetNodes: e, eventType: t, handler: o }), e.forEach((i) => i.addEventListener(t, o, y ? { passive: !0 } : void 0)));
                    },
                    ...
                    $_removeEventListeners(e) {
                        ...
                        (this.$_events.forEach((o) => {
                            ...
                            !e || e === n ? i.forEach((a) => a.removeEventListener(n, p)) : t.push(o);
                        }),
                            (this.$_events = t));
                    },
                    $_refreshListeners() {
                    ...
                    $_isAimingPopper() {
                        ...
                        if (v >= e.left && v <= e.right && T >= e.top && T <= e.bottom) {
                            const t = this.$_popperNode.getBoundingClientRect(),
                                o = v - g,
                                i = T - w,
                                p = t.left + t.width / 2 - g + (t.top + t.height / 2) - w + t.width + t.height,
                                a = g + o * p,
                                d = w + i * p;
                            return C(g, w, a, d, t.left, t.top, t.left, t.bottom) || C(g, w, a, d, t.left, t.top, t.right, t.top) || C(g, w, a, d, t.right, t.top, t.right, t.bottom) || C(g, w, a, d, t.left, t.bottom, t.right, t.bottom);
                        }
                        return !1;
                    },
                },
    ...
    if (typeof document < "u" && typeof window < "u") {
        if (oe) {
            ...
            (document.addEventListener("touchstart", (t) => re(t, !0), e), document.addEventListener("touchend", (t) => pe(t, !0), e));
        } else (window.addEventListener("mousedown", (e) => re(e, !1), !0), window.addEventListener("click", (e) => pe(e, !1), !0));
    ...
    function ae(e, t) {
        ...
        for (let i = h.length - 1; i >= 0; i--) {
            const n = h[i];
            try {
                const p = (n.containsGlobalTarget = n.mouseDownContains || n.popperNode().contains(e.target));
                ((n.pendingHide = !1),
                    requestAnimationFrame(() => {
                        if (((n.pendingHide = !1), !o[n.randomId] && de(n, p, e))) {
                            if ((n.$_handleGlobalClose(e, t), !e.closeAllPopover && e.closePopover && p)) {
    ...
    function C(e, t, o, i, n, p, a, d) {
        const f = ((a - n) * (t - p) - (d - p) * (e - n)) / ((d - p) * (o - e) - (a - n) * (i - t)),
            c = ((o - e) * (t - p) - (i - t) * (e - n)) / ((d - p) * (o - e) - (a - n) * (i - t));
    ...
    function Ae(e, t, o, i, n, p) {
        return (s.openBlock(), s.createElementBlock("div", { ref: "reference", class: s.normalizeClass(["v-popper", { "v-popper--shown": e.slotData.isShown }]) }, [s.renderSlot(e.$slots, "default", s.normalizeProps(s.guardReactiveProps(e.slotData)))], 2));
    }
    ...
    var z = {
        name: "ResizeObserver",
        props: { emitOnMount: { type: Boolean, default: !1 }, ignoreWidth: { type: Boolean, default: !1 }, ignoreHeight: { type: Boolean, default: !1 } },
        emits: ["notify"],
        mounted() {
            (I(),
                s.nextTick(() => {
    ...
    s.popScopeId();
    const He = Me((e, t, o, i, n, p) => (s.openBlock(), s.createBlock("div", Oe)));
    ((z.render = He), (z.__scopeId = "data-v-b329ee4c"), (z.__file = "src/components/ResizeObserver.vue"));
    const F = (e = "theme") => ({
            computed: {
                themeClass() {
                    return Ce(this[e]);
        ...
        ke = s.defineComponent({
            ...
            mixins: [F()],
            props: { popperId: String, theme: String, shown: Boolean, mounted: Boolean, skipTransition: Boolean, autoHide: Boolean, handleResize: Boolean, classes: Object, result: Object },
            emits: ["hide", "resize"],
            methods: {
                toPx(e) {
    ...
    const A = b(Re, [["render", Ve]]),
        ...
        je = s.defineComponent({
            ...
            mixins: [V],
            inheritAttrs: !1,
            props: { theme: { type: String, default: "tooltip" }, html: { type: Boolean, default: (e) => _(e.theme, "html") }, content: { type: [String, Number, Function], default: null }, loadingContent: { type: String, default: (e) => _(e.theme, "loadingContent") }, targetNodes: { type: Function, required: !0 } },
            data() {
    ...
    function ge(e, t, o) {
        let i;
        const n = typeof t;
        return (n === "string" ? (i = { content: t }) : t && n === "object" ? (i = t) : (i = { content: !1 }), (i.placement = Ue(i, o)), (i.targetNodes = () => [e]), (i.referenceNode = () => e), i);
    }
    let W,
        P,
        Ye = 0;
    function Xe() {
        ...
        ((P = s.ref([])),
            (W = s.createApp({
                ...
                render() {
                    return this.directives.map((t) => s.h(ce, { ...t.options, shown: t.shown || t.options.shown, key: t.id }));
                },
                devtools: { hide: !0 },
            })));
    ...
    function G(e) {
        if (e.$_popper) {
            ...
            (t !== -1 && P.value.splice(t, 1), delete e.$_popper, delete e.$_popperOldShown, delete e.$_popperMountTarget);
        }
    ...
    function $e(e, { value: t, modifiers: o }) {
        ...
        if (!i.content || _(i.theme || "tooltip", "disabled")) G(e);
            ...
            let n;
            (e.$_popper ? ((n = e.$_popper), (n.options.value = i)) : (n = we(e, t, o)), typeof t.shown < "u" && t.shown !== e.$_popperOldShown && ((e.$_popperOldShown = t.shown), t.shown ? n.show() : n.hide()));
        }
    }
    const q = {
        beforeMount: $e,
    ...
    function ye(e) {
        (e.addEventListener("mousedown", B), e.addEventListener("click", B), e.addEventListener("touchstart", ve, y ? { passive: !0 } : !1));
    }
    function _e(e) {
        (e.removeEventListener("mousedown", B), e.removeEventListener("click", B), e.removeEventListener("touchstart", ve), e.removeEventListener("touchend", Te), e.removeEventListener("touchcancel", Pe));
    }
    function B(e) {
    ...
    function ve(e) {
        if (e.changedTouches.length === 1) {
            ...
            ((t.$_vclosepopover_touchPoint = o), t.addEventListener("touchend", Te), t.addEventListener("touchcancel", Pe));
        }
    }
    function Te(e) {
        const t = e.currentTarget;
    ...
    const U = {
            ...
            updated(e, { value: t, oldValue: o, modifiers: i }) {
                ((e.$_closePopoverModifiers = i), t !== o && (typeof t > "u" || t ? ye(e) : _e(e)));
            },
            beforeUnmount(e) {
                _e(e);
            },
